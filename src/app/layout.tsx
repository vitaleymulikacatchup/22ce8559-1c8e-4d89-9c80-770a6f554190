...
export const metadata: Metadata = {
  title: "FC Barcelona - Més que un club | Official Website",
  description: "Experience the passion of FC Barcelona. Join millions of culers worldwide supporting the greatest football club in history. Camp Nou, La Masia, and more.",
  keywords: "FC Barcelona, Barça, football, soccer, Camp Nou, La Masia, Messi, culers, Spanish football, Champions League",
  openGraph: {
    title: "FC Barcelona - Més que un club",
    description: "Experience the passion of FC Barcelona. Join millions of culers worldwide supporting the greatest football club in history.",
    siteName: "FC Barcelona",
    images: [
      {
        url: "https://images.pexels.com/photos/12313588/pexels-photo-12313588.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "Camp Nou stadium aerial view"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "FC Barcelona - Més que un club",
    description: "Experience the passion of FC Barcelona. Join millions of culers worldwide supporting the greatest football club in history.",
    images: ["https://images.pexels.com/photos/12313588/pexels-photo-12313588.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
